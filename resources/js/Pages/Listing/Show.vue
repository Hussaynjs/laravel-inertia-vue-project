...
<template>
    ...
    <Container class="flex gap-4">
            ...
            <img
                :src="
                    listing.image
                        ...
                        : '/storage/images/listing/AATU.png'
                "
        ...
        <div class="w-3/4">
            <!-- Listing info -->
            <div class="mb-6">
                <div v-if="canModify" class="flex items-end justify-between mb-2">
                    ...
                    <Link
                            ...
                            class="bg-green-500 rounded-md mr-3 text-white px-6 py-2 hover:outline outline-green-500 outline-offset-2"
                        >
                            Edit
                        </Link>
